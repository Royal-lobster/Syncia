...
class RequestGraph extends _graph().ContentGraph {
  ...
  invalidateFileNameNode(node, filePath, matchNodes) {
    ...
    for (let matchNode of matchNodes) {
      ...
      if (this.hasEdge(nodeId, matchNodeId, requestGraphEdgeTypes.invalidated_by_create_above) && (0, _utils().isDirectoryInside)((0, _projectPath.fromProjectPathRelative)(matchNode.value.filePath), dirname)) {
