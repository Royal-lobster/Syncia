...
export declare type ParseExternalReferenceSchema<REF_SCHEMA extends ReferenceSchema, OPTIONS extends ParseSchemaOptions, REFERENCE extends string, DEFINITION extends string | undefined, REST_SCHEMA extends JSONSchema7 = Omit<REF_SCHEMA, "$ref">> = REFERENCE extends keyof OPTIONS["references"] ? ParseReference<OPTIONS["references"][REFERENCE], OPTIONS, DEFINITION, REST_SCHEMA> : OPTIONS extends {
    rootSchema: IdSchema;
