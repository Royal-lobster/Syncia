...
exports.PlanetScaleChatMessageHistory = void 0;
 ...
 */
class PlanetScaleChatMessageHistory extends index_js_1.BaseListChatMessageHistory {
    get lc_secrets() {
        return {
    ...
    constructor(fields) {
        ...
        if (client) {
            ...
            this.client = new database_1.Client(config);
        }
        else {
