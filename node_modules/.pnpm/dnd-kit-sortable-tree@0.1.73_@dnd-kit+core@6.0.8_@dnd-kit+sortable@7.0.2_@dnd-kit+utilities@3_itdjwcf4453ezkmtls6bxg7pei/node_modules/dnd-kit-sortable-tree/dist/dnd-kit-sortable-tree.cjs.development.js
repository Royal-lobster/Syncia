...
var SimpleTreeItemWrapper = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  }), !disableSorting && showDragHandle !== false && React__default.createElement("div", Object.assign({
    className: 'dnd-sortable-tree_simple_handle'
  }, handleProps)), !manualDrag && !hideCollapseButton && !!onCollapse && !!childCount && React__default.createElement("button", {
...
var FolderTreeItemWrapper = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var clone = props.clone,
      disableSelection = props.disableSelection,
      disableInteraction = props.disableInteraction,
      disableSorting = props.disableSorting,
  ...
  return React__default.createElement("li", Object.assign({}, rest, {
  ...
  }), manualDrag && showDragHandle && !disableSorting && React__default.createElement("div", Object.assign({
...
var SortableTreeItemNotMemoized = function SortableTreeItem(_ref2) {
  ...
  var _useSortable = sortable.useSortable(_extends({
    id: id,
  ...
  var isOverParent = React.useMemo(function () {
  ...
  var localCollapse = React.useMemo(function () {
  ...
  var localRemove = React.useMemo(function () {
  ...
  return React__default.createElement(TreeItemComponent, Object.assign({}, props, {
...
var SortableTreeItem = /*#__PURE__*/React__default.memo(SortableTreeItemNotMemoized);
...
var dropAnimationDefaultConfig = {
  keyframes: function keyframes(_ref) {
    ...
    return [{
      opacity: 1,
      transform: utilities.CSS.Transform.toString(transform.initial)
    }, {
      opacity: 0,
      transform: utilities.CSS.Transform.toString(_extends({}, transform["final"], {
...
function SortableTree(_ref3) {
  ...
  var sensors = core.useSensors(core.useSensor(core.PointerSensor, pointerSensorOptions != null ? pointerSensorOptions : defaultPointerSensorOptions) // useSensor(KeyboardSensor, {
  //   coordinateGetter,
  // })
  );
  ...
  var handleCollapse = React.useCallback(function handleCollapse(id) {
    var item = findItemDeep(itemsRef.current, id);
  ...
  var strategyCallback = React.useCallback(function () {
    return !!projected;
  }, [projected]);
  return React__default.createElement(core.DndContext, Object.assign({
    accessibility: {
  ...
  }, dndContextProps), React__default.createElement(sortable.SortableContext, {
    items: sortedIds,
    ...
    return React__default.createElement(SortableTreeItem, Object.assign({}, rest, {
      key: item.id,
      id: item.id,
      item: item,
  ...
  }), reactDom.createPortal(React__default.createElement(core.DragOverlay, {
    dropAnimation: dropAnimation === undefined ? dropAnimationDefaultConfig : dropAnimation
  }, activeId && activeItem ? React__default.createElement(TreeItemComponent, Object.assign({}, rest, {
    item: activeItem,
    children: [],
...
exports.FolderTreeItemWrapper = FolderTreeItemWrapper;
exports.SimpleTreeItemWrapper = SimpleTreeItemWrapper;
exports.SortableTree = SortableTree;
exports.flattenTree = flattenTree;
//# sourceMappingURL=dnd-kit-sortable-tree.cjs.development.js.map
