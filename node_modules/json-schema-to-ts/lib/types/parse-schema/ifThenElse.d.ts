...
export declare type ParseIfThenElseSchema<SCHEMA extends IfThenElseSchema, OPTIONS extends ParseSchemaOptions, REST_SCHEMA extends JSONSchema7 = Omit<SCHEMA, "if" | "then" | "else">, IF_SCHEMA extends JSONSchema7 = MergeSubSchema<REST_SCHEMA, SCHEMA["if"]>, PARSED_THEN_SCHEMA = SCHEMA extends {
    then: JSONSchema7;
