    ...
    <div className="cdx-mx-3 cdx-my-2 cdx-w-[70%] cdx-relative">
      <DropdownMenu.Root>
        <DropdownMenu.Trigger asChild>
          <div className=" cdx-rounded-full  cdx-w-[100%] cdx-h-8 cdx-px-3 cdx-flex cdx-items-center cdx-justify-between cdx-gap-2   cdx-shadow-[0_2px_10px] cdx-shadow-black cdx-focus:shadow-[0_0_0_2px] focus:cdx-shadow-black  cdx-text-md
       ...
       dark:cdx-border-neutral-800 cdx-border-neutral-300 dark:cdx-bg-neutral-900/90 cdx-bg-neutral-200/90  cdx-cursor-pointer
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            ...
            sideOffset={5}
          >
            <DropdownMenu.RadioGroup value={currentId} onValueChange={setCurrentId}>
